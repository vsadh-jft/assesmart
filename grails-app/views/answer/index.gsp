		...
		<div id="list-answer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="correctAnswer" title="${message(code: 'answer.correctAnswer.label', default: 'Correct Answer')}" />
				...
				<g:each in="${answerInstanceList}" status="i" var="answerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${answerInstance.correctAnswer}" /></td>
