	...
	<body>
		...
		<div id="show-answer" class="content scaffold-show" role="main">
			...
			<ol class="property-list answer">
				...
				<g:if test="${answerInstance?.correctAnswer}">
				<li class="fieldcontain">
					<span id="correctAnswer-label" class="property-label"><g:message code="answer.correctAnswer.label" default="Correct Answer" /></span>
					
						<span class="property-value" aria-labelledby="correctAnswer-label"><g:formatBoolean boolean="${answerInstance?.correctAnswer}" /></span>
